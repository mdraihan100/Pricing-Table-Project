...
function pricing_table_meta_boxes()
{
    add_meta_box(
        ...
        'pricing_table_columns_callback',
        'pricing_table',
        'side'
...
function pricing_table_columns_callback(){
    // echo 'pricing_table_details_callback';
    echo '<div class = "select_item">';
    echo '<label for="cars">Choose a Pricing Column:</label>';
...
//    echo '<input type="submit" name="save" id="publish" class="button button-primary button-large" value="Save">';
}
